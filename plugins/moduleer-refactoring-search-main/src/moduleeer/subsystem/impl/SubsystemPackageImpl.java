...
import moduleeer.subsystem.SubsystemFactory;
...
public class SubsystemPackageImpl extends EPackageImpl implements SubsystemPackage {
	 ...
	 * @see moduleeer.subsystem.SubsystemPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static SubsystemPackage init() {
		...
		SubsystemPackageImpl theSubsystemPackage = registeredSubsystemPackage instanceof SubsystemPackageImpl ? (SubsystemPackageImpl)registeredSubsystemPackage : new SubsystemPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEClass(moduleSubsystemEClass, ModuleSubsystem.class, "ModuleSubsystem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModuleSubsystem_Procedures(), theProcedurePackage.getProcedure(), null, "procedures", null, 0, -1, ModuleSubsystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
