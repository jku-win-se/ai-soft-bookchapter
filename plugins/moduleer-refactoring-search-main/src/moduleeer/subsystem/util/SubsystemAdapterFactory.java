...
public class SubsystemAdapterFactory extends AdapterFactoryImpl {
	...
	protected SubsystemSwitch<Adapter> modelSwitch =
		new SubsystemSwitch<Adapter>() {
			@Override
			public Adapter caseModuleSubsystem(ModuleSubsystem object) {
				return createModuleSubsystemAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link moduleeer.subsystem.ModuleSubsystem <em>Module Subsystem</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createModuleSubsystemAdapter() {
		return null;
	}
