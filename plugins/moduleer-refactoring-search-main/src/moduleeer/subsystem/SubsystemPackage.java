 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see moduleeer.subsystem.SubsystemFactory
 * @model kind="package"
 * @generated
 */
public interface SubsystemPackage extends EPackage {
	 ...
	 * @generated
	 */
	SubsystemPackage eINSTANCE = moduleeer.subsystem.impl.SubsystemPackageImpl.init();

	/**
	 * The meta object id for the '{@link moduleeer.subsystem.impl.ModuleSubsystemImpl <em>Module Subsystem</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see moduleeer.subsystem.impl.ModuleSubsystemImpl
	 * @see moduleeer.subsystem.impl.SubsystemPackageImpl#getModuleSubsystem()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link moduleeer.subsystem.ModuleSubsystem <em>Module Subsystem</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Module Subsystem</em>'.
	 * @see moduleeer.subsystem.ModuleSubsystem
	 * @generated
	 */
	EClass getModuleSubsystem();

	/**
	 * Returns the meta object for the reference list '{@link moduleeer.subsystem.ModuleSubsystem#getProcedures <em>Procedures</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Procedures</em>'.
	 * @see moduleeer.subsystem.ModuleSubsystem#getProcedures()
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link moduleeer.subsystem.impl.ModuleSubsystemImpl <em>Module Subsystem</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see moduleeer.subsystem.impl.ModuleSubsystemImpl
		 * @see moduleeer.subsystem.impl.SubsystemPackageImpl#getModuleSubsystem()
