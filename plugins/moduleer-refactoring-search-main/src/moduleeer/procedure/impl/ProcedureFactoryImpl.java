...
public class ProcedureFactoryImpl extends EFactoryImpl implements ProcedureFactory {
	...
	public static ProcedureFactory init() {
		try {
			ProcedureFactory theProcedureFactory = (ProcedureFactory)EPackage.Registry.INSTANCE.getEFactory(ProcedurePackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ProcedurePackage.PROCEDURE: return (EObject)createProcedure();
			case ProcedurePackage.EVENT: return (EObject)createEvent();
			case ProcedurePackage.ACCESS_ELEMENT: return (EObject)createAccessElement();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ProcedurePackage.PROCEDURE_TYPE:
				return createProcedureTypeFromString(eDataType, initialValue);
			case ProcedurePackage.OPERATION_TYPE:
	...
	public AccessElement createAccessElement() {
		AccessElementImpl accessElement = new AccessElementImpl();
