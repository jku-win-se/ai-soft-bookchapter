...
import moduleeer.impl.ModuleeerPackageImpl;
...
import moduleeer.procedure.ProcedureFactory;
...
public class ProcedurePackageImpl extends EPackageImpl implements ProcedurePackage {
	 ...
	 * @see moduleeer.procedure.ProcedurePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ProcedurePackage init() {
		if (isInited) return (ProcedurePackage)EPackage.Registry.INSTANCE.getEPackage(ProcedurePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredProcedurePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ProcedurePackageImpl theProcedurePackage = registeredProcedurePackage instanceof ProcedurePackageImpl ? (ProcedurePackageImpl)registeredProcedurePackage : new ProcedurePackageImpl();

		isInited = true;

		// Obtain or create and register interdependencies
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(ModuleeerPackage.eNS_URI);
		ModuleeerPackageImpl theModuleeerPackage = (ModuleeerPackageImpl)(registeredPackage instanceof ModuleeerPackageImpl ? registeredPackage : ModuleeerPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		ModuleeerPackage theModuleeerPackage = (ModuleeerPackage)EPackage.Registry.INSTANCE.getEPackage(ModuleeerPackage.eNS_URI);
		...
		initEAttribute(getProcedure_ProcedureType(), this.getProcedureType(), "procedureType", null, 0, 1, Procedure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcedure_Event(), this.getEvent(), null, "event", null, 0, 1, Procedure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcedure_AccessElements(), this.getAccessElement(), null, "accessElements", null, 0, -1, Procedure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(eventEClass, Event.class, "Event", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEvent_IntegrityProcedures(), this.getProcedure(), null, "integrityProcedures", null, 0, -1, Event.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(accessElementEClass, AccessElement.class, "AccessElement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAccessElement_Entity(), theModuleeerPackage.getElement(), theModuleeerPackage.getElement_AccessElement(), "entity", null, 1, 1, AccessElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAccessElement_AccessType(), this.getOperationType(), "accessType", null, 0, 1, AccessElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
