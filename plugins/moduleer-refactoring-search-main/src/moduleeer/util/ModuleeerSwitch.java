...
public class ModuleeerSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModuleeerPackage.MEER_MODEL: {
				...
				if (result == null) result = caseNameElement(meerModel);
			...
			case ModuleeerPackage.ELEMENT: {
				...
				if (result == null) result = caseModularizableElement(element);
				if (result == null) result = caseNameElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModuleeerPackage.MODULE: {
				moduleeer.Module module = (moduleeer.Module)theEObject;
				T result = caseModule(module);
				if (result == null) result = caseModularizableElement(module);
				if (result == null) result = caseNameElement(module);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModuleeerPackage.ENTITY_TYPE: {
				...
				if (result == null) result = caseModularizableElement(entityType);
				if (result == null) result = caseNameElement(entityType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModuleeerPackage.RELATIONSHIP_TYPE: {
				...
				if (result == null) result = caseModularizableElement(relationshipType);
				if (result == null) result = caseNameElement(relationshipType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModuleeerPackage.SINGLE_ATTRIBUTE: {
				...
				if (result == null) result = caseNameElement(singleAttribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModuleeerPackage.MODULARIZABLE_ELEMENT: {
				...
				if (result == null) result = caseNameElement(modularizableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModuleeerPackage.COMPOSITE_ATTRIBUTE: {
				...
				if (result == null) result = caseNameElement(compositeAttribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModuleeerPackage.LINK: {
				...
				if (result == null) result = caseNameElement(link);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModuleeerPackage.GENERALIZATION: {
				...
				if (result == null) result = caseNameElement(generalization);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModuleeerPackage.AGGREGATION: {
				...
				if (result == null) result = caseNameElement(aggregation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModuleeerPackage.LINK_TO_ENTITY: {
				...
				if (result == null) result = caseLink(linkToEntity);
				if (result == null) result = caseNameElement(linkToEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseModule(moduleeer.Module object) {
		return null;
	}
